...
public class Magpie
{
	...
	public String getResponse(String statement)
	{
		...
		{
			response = "Mr. Adiletta - what a dude!";
		}
		...
		else
		{
			...
			else if (psn1 >= 0 && psn1 >=0 && psn1 < psn)
			{
	...
	private String transformYouIStatement(String statement)
	{
		...
		int psnOfYou = findKeyword (statement, "you", 0);
		int psnOfI = findKeyword (statement, "i", psnOfYou + 1);
		
		String restOfStatement = statement.substring(psnOfI + 2, psnOfYou -1).trim();
